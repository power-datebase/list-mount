--[[
    MOUNT MEROHMOY EXECUTOR
    • Update: Nama UI Mount Merohmoy
...
-- === CHECKPOINT DATA (UPDATED: MOUNT MEROHMOY) ===
local checkpoints = {
...
local Title = create("TextLabel", {
    Parent = Header,
    Text = "Mount Merohmoy", -- UPDATED NAME
...
ToggleBg.MouseButton1Click:Connect(function()
    ...
    if isAuto then
        ...
        TweenService:Create(ToggleCircle, TweenInfo.new(0.2), {Position = UDim2.new(0, end
