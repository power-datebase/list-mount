--[[
    MOUNT FREESTYLE EXECUTOR (UPDATED)
    • Update: Nama UI menjadi MOUNT Freestyle
    • Update: Koordinat Checkpoint 1-17 & Submit baru
    • Fix: Pengecekan agar tidak eror setelah UI di-destroy
    • Fix: Lapisan (ZIndex) pada Popup Konfirmasi
]]
...
local checkpoints = {
    {name = "Checkpoint 2", pos = Vector3.new(-555, 16, -885)},
    {name = "Checkpoint 3", pos = Vector3.new(-10, 140, -690)},
    {name = "Checkpoint 4", pos = Vector3.new(90, 37, -738)},
    {name = "Checkpoint 5", pos = Vector3.new(369, 153, -919)},
    {name = "Checkpoint 6", pos = Vector3.new(747, 80, -756)},
    {name = "Checkpoint 7", pos = Vector3.new(628, 144, -586)},
    {name = "Checkpoint 8", pos = Vector3.new(549, 209, -465)},
    {name = "Checkpoint 9", pos = Vector3.new(653, 172, -196)},
    {name = "Checkpoint 10", pos = Vector3.new(995, 281, -132)},
    {name = "Checkpoint 11", pos = Vector3.new(1379, 253, -105)},
    {name = "Checkpoint 12", pos = Vector3.new(1790, 120, -71)},
    {name = "Checkpoint 13", pos = Vector3.new(2258, 121, -78)},
    {name = "Checkpoint 14", pos = Vector3.new(2680, 157, -81)},
    {name = "Checkpoint 15", pos = Vector3.new(3106, 145, 116)},
    {name = "Checkpoint 16", pos = Vector3.new(3433, 110, -166)},
    {name = "Checkpoint 17", pos = Vector3.new(3806, 217, -165)},
    {name = "SUBMIT", pos = Vector3.new(4146, 238, -182)}
}
...
local function ApplyRGBBorder(target, cornerRadius, zIndex)
    -- ZIndex default 100, tapi bisa diatur lebih tinggi (misal untuk popup)
...
if getgenv().MountKitaUI then 
    ...
    UI_Active = false -- Matikan loop script lama
end
UI_Active = true -- Hidupkan status untuk script baru
...
local Title = create("TextLabel", {
    Parent = Header,
    Text = "MOUNT Freestyle", -- Updated Name
...
local ConfirmFrame = create("Frame", {
    ...
    AnchorPoint = Vector2.new(0.5, 0.5),
    Visible = false,
    ZIndex = 200 -- Layer Popup Background
})
create("UICorner", {Parent = ConfirmFrame, CornerRadius = UDim.new(0, 8)})
-- Overlay Border harus lebih tinggi dari background (201)
...
ToggleBg.MouseButton1Click:Connect(function()
    ...
    if isAuto then
        ...
        showToast("Resume: " .. checkpoints[currentStep].name)
...
-- LOGIKA KELUAR (SAFE EXIT)
YesBtn.MouseButton1Click:Connect(function() 
    UI_Active = false -- Matikan semua loop
    isAuto = false -- Matikan auto
    ScreenGui:Destroy() 
end)
