--[[
    MOUNT YAHAYUK EXECUTOR (UPDATED)
    • Update: Nama UI menjadi Mount Yahayuk
    • Update: Koordinat Checkpoint 1-5 & Submit 6
]]
...
local checkpoints = {
    {name = "Checkpoint 1", pos = Vector3.new(-421, 249, 782)},
    {name = "Checkpoint 2", pos = Vector3.new(-338, 388, 522)},
    {name = "Checkpoint 3", pos = Vector3.new(294, 430, 495)},
    {name = "Checkpoint 4", pos = Vector3.new(323, 490, 347)},
    {name = "Checkpoint 5", pos = Vector3.new(226, 314, -142)},
    {name = "Submit 6",   pos = Vector3.new(-618, 905, -549)}
}
...
local Title = create("TextLabel", {
    Parent = Header,
    Text = "Mount Yahayuk", -- Updated Name
