--[[
    MOUNT ACTIVE EXECUTOR (UPDATED v2)
    • Update: Nama UI tetap Mount Active
    • Update: Koordinat Checkpoint 1-49
    • Update: Penambahan titik Submit (50)
]]
...
-- === CHECKPOINT DATA (UPDATED: MOUNT ACTIVE 50 POINTS) ===
local checkpoints = {
    {name = "Checkpoint 1",  pos = Vector3.new(-104, 69, 28)},
    {name = "Checkpoint 2",  pos = Vector3.new(-51, 249, 507)},
    {name = "Checkpoint 3",  pos = Vector3.new(-77, 253, 1360)},
    {name = "Checkpoint 4",  pos = Vector3.new(-99, 253, 1698)},
    {name = "Checkpoint 5",  pos = Vector3.new(-1003, 417, 1621)},
    {name = "Checkpoint 6",  pos = Vector3.new(-1583, 421, 1594)},
    {name = "Checkpoint 7",  pos = Vector3.new(-2426, 421, 1588)},
    {name = "Checkpoint 8",  pos = Vector3.new(-2806, 521, 1618)},
    {name = "Checkpoint 9",  pos = Vector3.new(-3372, 521, 1576)},
    {name = "Checkpoint 10", pos = Vector3.new(-3863, 521, 1603)},
    {name = "Checkpoint 11", pos = Vector3.new(-4470, 517, 1676)},
    {name = "Checkpoint 12", pos = Vector3.new(-4891, 517, 1685)},
    {name = "Checkpoint 13", pos = Vector3.new(-5322, 513, 1625)},
    {name = "Checkpoint 14", pos = Vector3.new(-5339, 513, 975)},
    {name = "Checkpoint 15", pos = Vector3.new(-5259, 509, -36)},
    {name = "Checkpoint 16", pos = Vector3.new(-5260, 1039, -785)},
    {name = "Checkpoint 17", pos = Vector3.new(-5386, 517, -1538)},
    {name = "Checkpoint 18", pos = Vector3.new(-5374, 765, -1798)},
    {name = "Checkpoint 19", pos = Vector3.new(-5381, 773, -2256)},
    {name = "Checkpoint 20", pos = Vector3.new(-5026, 829, -2689)},
    {name = "Checkpoint 21", pos = Vector3.new(-4621, 873, -2545)},
    {name = "Checkpoint 22", pos = Vector3.new(-4333, 1033, -2545)},
    {name = "Checkpoint 23", pos = Vector3.new(-3824, 1029, -2502)},
    {name = "Checkpoint 24", pos = Vector3.new(-3274, 1173, -2493)},
    {name = "Checkpoint 25", pos = Vector3.new(-2606, 1177, -2496)},
    {name = "Checkpoint 26", pos = Vector3.new(-2206, 1181, -2694)},
    {name = "Checkpoint 27", pos = Vector3.new(-2241, 1353, -2977)},
    {name = "Checkpoint 28", pos = Vector3.new(-2255, 1205, -3166)},
    {name = "Checkpoint 29", pos = Vector3.new(-2180, 1205, -3689)},
    {name = "Checkpoint 30", pos = Vector3.new(-2234, 1209, -4313)},
    {name = "Checkpoint 31", pos = Vector3.new(-2270, 1213, -4828)},
    {name = "Checkpoint 32", pos = Vector3.new(-2673, 1337, -4901)},
    {name = "Checkpoint 33", pos = Vector3.new(-2828, 1257, -4836)},
    {name = "Checkpoint 34", pos = Vector3.new(-3322, 1257, -4809)},
    {name = "Checkpoint 35", pos = Vector3.new(-3627, 1257, -4615)},
    {name = "Checkpoint 36", pos = Vector3.new(-4013, 1257, -4373)},
    {name = "Checkpoint 37", pos = Vector3.new(-4116, 1345, -4372)},
    {name = "Checkpoint 38", pos = Vector3.new(-4250, 1473, -4556)},
    {name = "Checkpoint 39", pos = Vector3.new(-4297, 1465, -5187)},
    {name = "Checkpoint 40", pos = Vector3.new(-4612, 1725, -5245)},
    {name = "Checkpoint 41", pos = Vector3.new(-4839, 1729, -4835)},
    {name = "Checkpoint 42", pos = Vector3.new(-4828, 1597, -4644)},
    {name = "Checkpoint 43", pos = Vector3.new(-4922, 1485, -4249)},
    {name = "Checkpoint 44", pos = Vector3.new(-5096, 1401, -3807)},
    {name = "Checkpoint 45", pos = Vector3.new(-5488, 1305, -3576)},
    {name = "Checkpoint 46", pos = Vector3.new(-5854, 1163, -3567)},
    {name = "Checkpoint 47", pos = Vector3.new(-5885, 1157, -4057)},
    {name = "Checkpoint 48", pos = Vector3.new(-5889, 1149, -4355)},
    {name = "Checkpoint 49", pos = Vector3.new(-5903, 1149, -4779)},
    {name = "Submit",        pos = Vector3.new(-5943, 1662, -5672)}
}
