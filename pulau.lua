--[[
    PULAU APUNG EXECUTOR (UPDATED v2)
    • Update: Koordinat Submit diperbarui
    • Update: Penambahan titik Basecamp di akhir (Total 36 Titik)
]]
...
-- === CHECKPOINT DATA (UPDATED: 34 CP + SUBMIT + BASECAMP) ===
local checkpoints = {
    {name = "Checkpoint 1",  pos = Vector3.new(1118, 1017, 921)},
    {name = "Checkpoint 2",  pos = Vector3.new(1172, 1016, -478)},
    {name = "Checkpoint 3",  pos = Vector3.new(2200, 1016, -2191)},
    {name = "Checkpoint 4",  pos = Vector3.new(2270, 1016, -3464)},
    {name = "Checkpoint 5",  pos = Vector3.new(3667, 1280, -4388)},
    {name = "Checkpoint 6",  pos = Vector3.new(4992, 1524, -3811)},
    {name = "Checkpoint 7",  pos = Vector3.new(6440, 1524, -3764)},
    {name = "Checkpoint 8",  pos = Vector3.new(7304, 1744, -2731)},
    {name = "Checkpoint 9",  pos = Vector3.new(8479, 1456, -1155)},
    {name = "Checkpoint 10", pos = Vector3.new(9815, 1456, 46)},
    {name = "Checkpoint 11", pos = Vector3.new(11217, 1456, -155)},
    {name = "Checkpoint 12", pos = Vector3.new(12073, 1456, 833)},
    {name = "Checkpoint 13", pos = Vector3.new(13873, 1828, 830)},
    {name = "Checkpoint 14", pos = Vector3.new(15649, 1828, 570)},
    {name = "Checkpoint 15", pos = Vector3.new(16238, 2005, -525)},
    {name = "Checkpoint 16", pos = Vector3.new(15738, 2385, -1934)},
    {name = "Checkpoint 17", pos = Vector3.new(15670, 2385, -3355)},
    {name = "Checkpoint 18", pos = Vector3.new(14522, 2701, -4376)},
    {name = "Checkpoint 19", pos = Vector3.new(13010, 3045, -5184)},
    {name = "Checkpoint 20", pos = Vector3.new(12145, 3045, -6691)},
    {name = "Checkpoint 21", pos = Vector3.new(12266, 3421, -7944)},
    {name = "Checkpoint 22", pos = Vector3.new(13574, 3421, -9114)},
    {name = "Checkpoint 23", pos = Vector3.new(14834, 3785, -9052)},
    {name = "Checkpoint 24", pos = Vector3.new(15949, 3785, -7934)},
    {name = "Checkpoint 25", pos = Vector3.new(16506, 4045, -6794)},
    {name = "Checkpoint 26", pos = Vector3.new(17378, 4044, -5818)},
    {name = "Checkpoint 27", pos = Vector3.new(17462, 4044, -4161)},
    {name = "Checkpoint 28", pos = Vector3.new(18964, 4044, -2769)},
    {name = "Checkpoint 29", pos = Vector3.new(21747, 3929, -2196)},
    {name = "Checkpoint 30", pos = Vector3.new(22008, 5843, -1978)},
    {name = "Checkpoint 31", pos = Vector3.new(22041, 6809, -1886)},
    {name = "Checkpoint 32", pos = Vector3.new(22158, 7760, -1893)},
    {name = "Checkpoint 33", pos = Vector3.new(22299, 8726, -1899)},
    {name = "Checkpoint 34", pos = Vector3.new(22438, 9686, -1902)},
    {name = "Submit",        pos = Vector3.new(22669, 10653, -1905)}, -- Updated
    {name = "Basecamp",      pos = Vector3.new(22684, 10653, -1824)}  -- Added
}
