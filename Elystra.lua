--[[
    MOUNT ELYSTRA EXECUTOR (UPDATED)
    • Update: Nama UI menjadi Mount Elystra
    • Update: Koordinat Checkpoint 1-13 & Submit
]]
...
-- === CHECKPOINT DATA (UPDATED: MOUNT ELYSTRA) ===
local checkpoints = {
    {name = "Checkpoint 1",  pos = Vector3.new(6, 435, -25)},
    {name = "Checkpoint 2",  pos = Vector3.new(39, 433, -963)},
    {name = "Checkpoint 3",  pos = Vector3.new(290, 803, -1944)},
    {name = "Checkpoint 4",  pos = Vector3.new(956, 799, -1936)},
    {name = "Checkpoint 5",  pos = Vector3.new(1713, 803, -1998)},
    {name = "Checkpoint 6",  pos = Vector3.new(2741, 795, -1987)},
    {name = "Checkpoint 7",  pos = Vector3.new(4124, 791, -2035)},
    {name = "Checkpoint 8",  pos = Vector3.new(5324, 791, -1818)},
    {name = "Checkpoint 9",  pos = Vector3.new(5176, 803, -594)},
    {name = "Checkpoint 10", pos = Vector3.new(4655, 963, 848)},
    {name = "Checkpoint 11", pos = Vector3.new(4132, 939, 2353)},
    {name = "Checkpoint 12", pos = Vector3.new(5256, 1155, 2964)},
    {name = "Checkpoint 13", pos = Vector3.new(6500, 1377, 2721)},
    {name = "SUBMIT",        pos = Vector3.new(7472, 1378, 2652)}
}
...
local Title = create("TextLabel", {
    Parent = Header,
    Text = "Mount Elystra", -- Updated Name
